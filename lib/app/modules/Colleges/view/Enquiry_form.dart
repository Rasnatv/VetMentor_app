      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── Phone field ────────────────────────────────────────────────
            // PhoneFormField auto-limits digits per country via libphonenumber.
            // Switching country updates the length formatter internally —
            // no manual digit-length map needed. Validation lives in
            // DValidator.validatePhoneNumber(context), which composes
            // PhoneValidator.required + PhoneValidator.validMobile against
            // whichever country is selected in _phoneCtrl.
            _label('Phone *',
              PhoneFormField(
                controller: _phoneCtrl,
                // Country flag + dial-code button on the left
                ...
                // Centralized, country-aware validation via DValidator
