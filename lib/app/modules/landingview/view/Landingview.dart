...
import '../../careers/careers_Screen.dart';
import '../../home/bindings/home_binding.dart';
import '../../home/view/bottomaddbanner.dart';
import '../../home/view/homescreen.dart';
import '../../Colleges/view/collegescreen.dart';
import '../../mentor/views/mentor.dart';
import '../../newsevents/news_eventssection.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Obx(
          ...
          final index = controller.currentIndex.value;
          return Scaffold(
            // Ad banner sits directly above VetBottomNav. VetBottomNav
            // already applies MediaQuery bottom padding internally, so
            // we don't wrap this in an extra SafeArea (that would double
            // up the bottom inset).
