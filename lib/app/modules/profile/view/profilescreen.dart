...
//                         // ✅ was: hardcoded TextStyle — now matches HomeScreen pattern
...
//                   child: Text(
//                     initials,
//                     // ✅ was: raw TextStyle(fontSize, fontWeight, color: white)
//                     //    now: matches HomeScreen hero → displayWhite + r.fontSize
...
//                         // ✅ matches HomeScreen hero subtitle pattern
...
//             label,
//             // ✅ was: raw TextStyle(fontSize, fontWeight, color: white)
//             //    now: bodyWhite (same white text style as HomeScreen hero body)
//             style: AppTextStyles.bodyWhite.copyWith(
//               fontSize: r.fontSize(11),
...
//               ),
//               child: Container(
//                 width: r.value(mobile: r.spacing(100), tablet: r.spacing(120)),
...
//                     Text(
//                       'NEET',
//                       // ✅ was: AppTextStyles.bodySmall + hardcoded color
//                       //    now: bodyGreen matches HomeScreen's "Know More" green label pattern
...
//                         Text(
//                           score,
//                           // ✅ was: raw titleLarge + hardcoded color: AppColors.primary
//                           //    now: bodyGreen for primary-colored large text (consistent with HomeScreen)
//                           style: AppTextStyles.bodyGreen.copyWith(
...
//                             // ✅ keep icon color as-is (it's a Color constant, not a style)
//                             color: const Color(0xFF3B6D11),
//                           ),
//                           SizedBox(width: r.spacing(AppDimens.paddingXS)),
//                           Text(
//                             'Eligible',
//                             // ✅ was: raw TextStyle(fontSize, fontWeight, color)
//                             //    now: bodySmall + copyWith, matching _InfoCard row pattern
//                             style: AppTextStyles.bodySmall.copyWith(
//                               fontSize: r.fontSize(12),
//                               fontWeight: FontWeight.w600,
//                               color: const Color(0xFF3B6D11),
...
//                             'Submitted',
//                             // ✅ was: raw TextStyle(fontSize, fontWeight, color)
//                             //    now: bodySmall.copyWith — consistent with all other labels
//                             style: AppTextStyles.bodySmall.copyWith(
//                               fontSize: r.fontSize(11),
//                               fontWeight: FontWeight.w500,
//                               color: const Color(0xFF3B6D11),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // Show first 2 college name previews
                    if (!isEmpty) ...[
                      SizedBox(height: r.spacing(AppDimens.paddingXS + 2)),
                      ...savedColleges.take(2).map(
                            (c) => Padding(
                          padding: EdgeInsets.only(
                              bottom: r.spacing(AppDimens.paddingXS - 1)),
                          child: Row(
                            children: [
                              Icon(
